          ...
          <div class="service-list" style="margin-top: 1rem; margin-bottom: 2rem;">
            ...
            <div style="background-color: #f8f9fa; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem;">
              <ul style="list-style-type: none; padding-left: 0; margin-bottom: 0;">
                <li style="margin-bottom: 0.7rem; display: flex;"><i class="fas fa-pen-fancy" style="color: #17A589; margin-right: 15px; width: 20px;"></i> Associate Editor, International Journal of Pattern Recognition and Artificial Intelligence, Jan. 2025~Now</li>
