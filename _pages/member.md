      ...
      <div class="jp-card" data-aos="fade-up">
        ...
        <div class="jp-card-footer">
          <div class="jp-link-group">
            {% if student.email and student.coffee_chat == nil %}
            ...
            {% endif %}
            {% if student.coffee_chat %}
            <a href="mailto:{{ student.email }}" class="jp-coffee-chat" title="{{ student.coffee_chat }} — email {{ student.email }}">
              <i class="fas fa-mug-hot"></i> {{ student.coffee_chat }}
            </a>
            {% endif %}
          </div>
        </div>
...
/* Coffee-chat call-to-action pill (sits beside the email icon) */
.jp-coffee-chat {
  display: inline-flex;
  align-items: center;
  gap: 0.35rem;
